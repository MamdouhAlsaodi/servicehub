...
| PAY-05 CSV financial export | **ناقص** | لا CSV/export endpoint evidence. |
...
| ADM-04 disputes/refund decision | **جزئي** | disputes queue موجود؛ workflow قرار/refund ليس مثبتاً بالكامل. |
...
| REV-04 abuse report | **ناقص** | لا moderation/report flow. |

### 6) Messaging وNotifications وi18n

| PRD | الحالة | الدليل / الفجوة |
|---|---|---|
| MSG-01 booking-linked direct chat | **ناقص** | schema يتوقع Message، لكن لا module/controller/UI evidence. |
...
| I18N-01 Arabic RTL + English LTR كامل | **جزئي** | root layout RTL/ar موجود؛ لا locale switching أو translation framework/files. |
...
| Performance P95 <300ms / LCP <2.5s | ❌ غير مقاس | لا load/performance harness أو production telemetry. |
